---
description: Revisão independente factual, metodológica e de comitê de um relatório existente
argument-hint: "[caminho do relatorio.html ou pasta da análise]"
---

Carregue `er-analise` e revise: $ARGUMENTS

Localize, quando existirem, `economic-map.md`, `valuation/valuation-case.md`, `inputs.json`, `outputs.json` e as fontes do caso.

Rode em contextos separados:
