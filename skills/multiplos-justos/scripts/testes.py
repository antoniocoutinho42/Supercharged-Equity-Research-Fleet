...
# [v10.1/Fleet v6] A doutrina foi modularizada. Os testes documentais continuam
# validando o MESMO conteúdo econômico, mas leem bundles lógicos em vez de presumir
# que SKILL.md e aplicacao.md sejam monólitos.
def _doc_bundle(rel):
    root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    bundles = {
        'SKILL.md': [
            'SKILL.md',
            'references/core/identities-and-neutralities.md',
            'references/core/gates.md',
            'references/core/monetary-regime.md',
            'references/special-cases/releveraging.md',
            'references/core/motor.md',
            'references/development/legacy-entry-and-flow-v10.1.md',
            'references/diagnostics/mandatory.md',
            'references/development/legacy-reporting-v10.1.md',
            'references/development/round-closing.md',
        ],
        'references/aplicacao.md': [
            'references/operations/research-evidence.md',
            'references/valuation/premise-derivation.md',
            'references/valuation/terminal.md',
            'references/diagnostics/scenarios-reverse.md',
            'references/development/legacy-reporting-v10.1.md',
            'references/development/legacy-case-schema-v10.1.md',
            'references/operations/calculation-chains.md',
            'references/valuation/drivers-level.md',
            'references/valuation/capacity.md',
            'references/special-cases/financials.md',
            'references/special-cases/multi-segment.md',
            'references/special-cases/stock-mark-and-scope.md',
            'references/theory/jurisprudence.md',
        ],
        'references/derivacao.md': ['references/theory/derivacao.md'],
        'references/paper-multiplos-justos-v3.md': ['references/theory/paper-multiplos-justos-v3.md'],
        'references/manutencao.md': ['references/development/manutencao.md'],
    }
    paths = bundles.get(rel, [rel])
    return '\n\n'.join(open(os.path.join(root, p), encoding='utf-8').read() for p in paths)
...
def rec_v927_consistencia_cross_layer():
    ...
    check('v9.32 manual de manutenção existe e é citado',
          os.path.exists(os.path.join(root, 'references/development/manutencao.md'))
          and ('`references/development/manutencao.md`' in skill
               or '`references/manutencao.md`' in skill))
